  ...
  function deleteProduct(id) {
    ...
    axios
      ...
      .then(() => {
        ...
        setProducts((prev) =>
          prev.filter((item) => item._id !== id && item.productId !== id)
        );
      })
      .catch(() => {
  ...
  return (
    <div className="min-h-screen w-full p-6 bg-[#121212] relative overflow-auto">
      ...
      {!isLoading ? (
            ...
            <table className="w-full text-center border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-[#8B1A24] text-white">
                  <th className="p-3 rounded-tl-xl">Product ID</th>
              ...
              products.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300">ID: {item.productId}</p>
                  ...
                  <div className="flex gap-4">
                    <FaTrashCan
                      ...
                      onClick={() => deleteProduct(item._id || item.productId)}
                    />
        ...
        <h1 className="text-center text-[#FF8A75] text-xl">Loading...</h1>
      )}
    </div>
  );
}
